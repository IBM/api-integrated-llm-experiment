...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="sql_translation_output/dev/sequencing_bird_superhero.json",
    )
    parser.add_argument(
        "-d", "--dataset", type=str, required=False, default="superhero"
    )
    parser.add_argument(
        "--database_directory",
        type=str,
        ...
        default=os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "../../db/dev_databases/"
        ),
    )
    ...
    for p in payloads:
        ...
        p["model_output"] = model_output

    win_rate = evaluate_win_rate(payloads, builder)
    print(f"FILE: {input_file}, WIN RATE = ", win_rate)
